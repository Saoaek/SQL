...
-- Create a view to calculate the population for the years 2000 (1st year in the data) and 2010 (latest year in the data).

CREATE VIEW pop_diff AS 
SELECT cou.continent,
	cou.name,
    pop.year,
    pop.population,
...
-- Create a view for countries with a pop_2000_2010_dif less than 0, indicating a likely population decrease trend.
CREATE VIEW pop_diff_dec AS
SELECT *
FROM pop_diff
WHERE pop_2000_2010_dif < 0;

-- Create a view for countries with a pop_2000_2010_dif greater than 0, indicating a likely population increase trend
